---
name: Sunnyside Restaurant & Lodge
city: tahoe-city
category: stay
...
lng: -120.1601
phone: null
website: https://www.sunnysidelodge.com
dog_policy:
  allowed: indoors
  leash_required: true
  water_bowls: null
  size_or_breed_restrictions: Pet-designated rooms only; not in interior common areas or anywhere food is served.
  fee: $60 per stay
  notes: >-
    Official pet policy: $60 pet fee per stay, leashed at all times on
    property, no pets in the lodge's interior common areas or food-service
    areas. The lodge prefers pets not be left unattended in rooms — if
    unavoidable, they must be in a carrier.
seasonal: []
verification:
  last_verified: 2026-08-04
  method: official_website
  source_url: https://www.sunnysidelodge.com/pet-policy/
affiliate:
