...
dog_policy:
  ...
  fee: null
  notes: >-
    The town's designated dog space, run by TCPUD — a fenced field next to
    Conners Field with a water spigot, free clean-up bags, and seating.
    TCPUD's page asks simply that you clean up after your pets and respect
    the park. Open year-round, dawn to dusk.
seasonal: []
verification:
  last_verified: 2026-08-04
  method: official_website
  source_url: https://www.tcpud.org/parks-facilities/facilities-parks-and-rentals/parks/dog-park
affiliate: null
tags: []
summary: The one legal off-leash spot in town — a fenced TCPUD field with a water spigot and free bags, open dawn to dusk.
image: null
---
