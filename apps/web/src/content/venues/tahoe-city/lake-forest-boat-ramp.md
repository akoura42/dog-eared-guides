---
name: Lake Forest Boat Ramp at Pomin Park
city: tahoe-city
category: beach
...
lng: -120.1195
phone: (530) 583-3796
website: https://www.tcpud.org/parks
dog_policy:
  ...
  fee: null
  notes: >-
    TCPUD's own FAQ, answering whether Tahoe City has any dog beaches:
    "dogs are allowed next to the boat ramp in Lake Forest/Pomin Park" —
    and otherwise, no. The FAQ doesn't state a leash rule for the ramp
    area, but Placer County's leash law applies everywhere in town.
seasonal:
  - Boat ramp operations are seasonal; the shoreline area is accessible year-round.
verification:
